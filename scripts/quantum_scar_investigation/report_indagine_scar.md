...
Report della sessione di verifica su `frustrazione_quantistica.py` (griglie Ising frustrate 3x3/4x4 simulate con Dense Evolution) e sul confronto con il modello PXP.
