...
<tr><td style="padding:8px 10px;border-bottom:1px solid #eef0f2">Any of 4 checked mechanisms gravitationally sources the metric</td><td style="padding:8px 10px;border-bottom:1px solid #eef0f2">Refuted</td><td style="padding:8px 10px;border-bottom:1px solid #eef0f2">5</td><td style="padding:8px 10px;border-bottom:1px solid #eef0f2">Canonical/multiplet scalar, NLED, healthy k-essence, entropic gravity: each fails for a distinct, verified reason</td></tr>
