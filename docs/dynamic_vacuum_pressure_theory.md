...
Before the vacuum's waves settle into any stable combination, there is no pressure point and no dynamics: without convexity there is nothing to hold a difference in, no tension, no motion &mdash; that state is absolute nothingness, the exact opposite of memory, since nothing is precisely what has no trace to record. Dynamics begins only when this changes: a tear in that nothingness releases energy, and that release is what first creates dynamics where none existed. When the vacuum's waves settle into a stable combination inside that newly-dynamical space, a pressure point is born &mdash; a configuration of energy that manages to concentrate and hold itself in tension. What happens next depends entirely on how long that configuration lasts. If it persists, it stabilizes into a visible particle. If it does not, its energy is still not lost, because in a dynamical space nothing recorded as energy ever is: the vacuum's convexity is exactly what conserves that trace, rather than letting it escape back into the nothingness that preceded the tear. That conserved trace is dark matter: not a residue left over when convexity fails, but the opposite &mdash; the record convexity keeps precisely because it holds, cycle after cycle.

Gravity is how this conserved trace manifests and binds cosmic structures together; dark matter guides the gravity of galaxies and constellations because it is where the vacuum's convexity keeps that trace. Energy that fails to stabilize as a visible particle does not leave the vacuum's dynamics or escape into some separate "space": it stays exactly where convexity already conserves every trace, in the same dark matter that was never anything but that conservation, and it is from there that it discharges as gravity. The one purpose running through all of this is to keep no trace of that dynamics from ever being lost.

On this view, we are ourselves pressure points in the cosmic vacuum. That atomic nuclei occupy a vanishing fraction of the atom's volume is not a new observation &mdash; it was established by Geiger & Marsden's 1909 gold-foil scattering experiment and Rutherford's 1911 analysis of it [17], the founding result behind mass-energy equivalence: what we perceive as solid matter is condensed energy, not stuff. What this framework adds to that old fact is a specific reading of it: the condensed energy we call matter is itself a vibrating dynamic pressure &mdash; the same pressure-point mechanism described above, recurring at a different scale. A pressure point can always disappear, but disappearance does not mean its dynamics stops or its energy escapes the vacuum: convexity is exactly what keeps that from happening, conserving the point's energy as a trace in dark matter &mdash; encoded there as gravitational memory &mdash; rather than letting it fall back into undifferentiated, non-convex nothingness. The universe's way of not repeating a disappearance is active, not passive, for exactly this reason: when a configuration disappears at the end of its cycle, its reappearance draws on that conserved trace rather than starting from nothing. The claimed observational signature: stellar nucleosynthesis follows a specific, non-random sequence, not an arbitrary one &mdash; Hoyle's 1954 prediction of a resonance in carbon-12 [18], confirmed experimentally three years later [19], is the sharpest real example: without that exact resonance, stars would not produce enough carbon for the chemistry of life to exist at all. Burbidge, Burbidge, Fowler & Hoyle's full theory of stellar nucleosynthesis [20] is the broader real theory this ordering sits inside. Read here as a trace of processes drawing on the same gravitational memory this framework proposes, rather than recurring independently and randomly each time. Persistence, in this picture, is closer to error avoidance than to a static tendency to survive.

This raises the natural question: how can the universe already be ordered at its birth, and where is the memory that orders it actually stored? Within this framework the answer is direct, not a separate assumption: the memory is stored exactly where this story already puts it &mdash; in dark matter and dark energy, the trace of pressure-information that the vacuum's convexity conserves as each configuration runs its cycle, whether or not that configuration goes on to stabilize as a visible particle. That dark matter is what structures where and how galaxies and stars form is itself real, established astrophysics, not a new claim of this framework: White & Rees's 1978 two-stage theory [21] showed that dark matter halos collapse first under gravity alone, and galaxies &mdash; and the stars within them &mdash; condense afterward inside those halos as gas dissipates and cools. What directs stellar formation, on this view, is not a separate, unexplained agent: it is that same stored gravitational memory acting on new pressure points as they form.
